...
public class Mail {
    ...
    public static void main(String[] args) {
        Mail mail = new Mail();
        mail.setAddress("tangyibo@ruijie.com.cn", Mail.TO);
        // 设置发送邮箱
        mail.setFromAddress("ruijie_alter@sina.com");
        mail.setSMTPHost("smtp.sina.com", "ruijie_alter@sina.com", "ruijie");
