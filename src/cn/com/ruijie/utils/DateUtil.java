...
/**
 * 功能：日期处理的工具类 获取YYYY格式 获取yyyy-MM-dd格式 获取yyyyMMdd格式
 * 获取yyyy-MM-dd HH:mm:ss格式 格式化日期 日期比较，如果s>=e 返回true 否则返回false) 检验日期是否合法
 * 得到两个日期相差的年数 时间相减得到天数 得到n天之后的日期 得到n天后是周几
 */
public class DateUtil {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(DateUtil.isValidDate("2012-3-15"));
        System.out.println(DateUtil.getDiffYear("2012-3-15", "2015-3-24"));
        System.out.println(DateUtil.getAfterDayDate("5"));
        System.out.println(DateUtil.getAfterDayWeek("3"));
    }
}
